    ...
    return (
        <>
            <div className="container" style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
                ...
                <button className="btn btn-primary mx-1 my-1" onClick={handleInverseClick} >Reverse & Normal</button>
                <button className="btn btn-primary mx-1 my-1" onClick={handleCopyClick} >Copy All</button>
                <button className="btn btn-primary mx-1 my-1" onClick={handleSpacesClick} >Remove Spaces</button>
            </div>
